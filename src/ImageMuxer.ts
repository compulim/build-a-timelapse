...
const READY_STATE_IDLE = 0;
const READY_STATE_BUSY = 1;

type ReadyState = typeof READY_STATE_IDLE | typeof READY_STATE_BUSY;

export default class ImageMuxer extends EventTarget {
